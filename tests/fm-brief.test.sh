...
test_faster_paths_use_configured_authority_without_stacked_review() {
  ...
  brief="$home/data/$id/brief.md"
  assert_grep "The configured merge authority approves the ready branch, then firstmate lands it through the guarded fast-forward path." "$brief" \
    "local-only brief lost configured merge authority and guarded target landing"
